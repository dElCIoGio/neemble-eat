...
import {ItemsDisplayContext} from "@/context/itemsDisplayContext.ts";
...
export function ItemsDisplay({items}: ItemsDisplayProps) {
    ...
    const [deleteItemAlert, setDeleteItemAlert] = useState<boolean>(false)
    ...
    return (
        <ItemsDisplayContext.Provider value={{
            setDeleteItemAlert, deleteItemAlert
        }}>
