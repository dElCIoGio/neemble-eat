...
const faq: {
    ...
    {
        question: "1. O que é o Neemble Eat",
    ...
    {
        question: "2. Como funciona o sistema de QR Code?",
    ...
    {
        question: "3. É possível adicionar observações aos pedidos?",
    ...
    {
        question: "4. Posso fazer múltiplos pedidos durante a refeição?",
        answer: "Sim! O cliente pode fazer quantos pedidos desejar antes de solicitar a conta final."
    },
    {
        question: "5. O aplicativo permite realizar pagamentos?",
    ...
    {
        question: "6. Como o restaurante pode atualizar o menu?",
    ...
    {
        question: "7. O sistema funciona offline?",
